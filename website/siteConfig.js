...
const siteConfig = {
  ...
  baseUrl: process.env.NODE_ENV === "development" ? "/" : "/luiz-tech-notes/", // Base URL for your project */
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Luiz Silva`,
  ...
  repoUrl: "https://github.com/Luiz-Silva19/luiz-tech-notes",
};
